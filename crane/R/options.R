...
#' 
#' @details the matching environment variable for an option can be found by replacing dot separators with underscores and uppercasing all letters. For example, the R option `crane.config.file` matches the environment variable `CRANE_REPO_CONFIG`.
